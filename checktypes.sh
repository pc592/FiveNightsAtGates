...
ocamlbuild -use-ocamlfind -tag thread -pkgs oUnit,yojson,str,ANSITerminal,async,threads main.byte engine.byte
if [[ $? -ne 0 ]]; then
  cat <<EOF
===========================================================
WARNING
...
if ocamlbuild -use-ocamlfind -tag thread -pkgs oUnit,yojson,str,ANSITerminal,async,threads checktypes.byte ; then
  cat <<EOF
===========================================================
