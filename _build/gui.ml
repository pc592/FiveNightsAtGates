...
(* Helper function to construct the view of the main room and updates the screen
given parameters.*)
...
(* Helper function to handle the keyboard events. Mappings are found in the
instructions.jpg in the menu folder *)
